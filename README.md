...
* 编译命令spark3.1.2(一定要添加spark对应版本): **build/mvn clean package -T 16 -pl :kyuubi-spark-lineage_2.12 -am -Dspark.version=3.1.2 -DskipTests -Dmaven.test.skip=true**
* 编译命令spark3.4.3(一定要添加spark对应版本): **build/mvn clean package -T 16 -pl :kyuubi-spark-lineage_2.12 -am -Dspark.version=3.4.3 -DskipTests -Dmaven.test.skip=true**
* 插件包位置: incubator-kyuubi/extensions/spark/kyuubi-spark-lineage/target/kyuubi-spark-lineage_2.12-1.8.0.jar
