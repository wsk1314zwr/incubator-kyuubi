...
import org.apache.spark.kyuubi.lineag2.LineageConf.{DISPATCHERS, SKIP_PARSING_PERMANENT_VIEW_ENABLED}
...
import org.apache.kyuubi.plugin.lineage2.dispatcher.atlas.AtlasEntityHelper.{COLUMN_LINEAGE_TYPE, PROCESS_TYPE}
